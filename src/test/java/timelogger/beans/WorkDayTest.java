...
public class WorkDayTest {
    ...
    @Test
    public void testGetExtraMinPerDayNegative() throws NegativeMinutesOfWorkException, FutureWorkException, InvalidTaskIdException, NoTaskIdException, EmptyTimeFieldException, NotSeparatedTaskTimesException, NotMultipleQuarterHourException, NotExpectedTimeOrderException {
    ...
    @Test
    public void testGetSumPerDayNormal() throws NegativeMinutesOfWorkException, FutureWorkException, InvalidTaskIdException, NoTaskIdException, EmptyTimeFieldException, NotSeparatedTaskTimesException, NotMultipleQuarterHourException, NotExpectedTimeOrderException {
        WorkDay workDay = getNormalWorkDayWithDate();
    ...
    public void testAddTaskNotSeparatedTimes() throws NegativeMinutesOfWorkException, FutureWorkException, InvalidTaskIdException, NoTaskIdException, EmptyTimeFieldException, NotSeparatedTaskTimesException, NotMultipleQuarterHourException, NotExpectedTimeOrderException {
        WorkDay workDay = getNormalWorkDayWithDate();
    ...
    @Test(expected = NotSeparatedTaskTimesException.class)
    public void testAddTaskNotSeparatedTimesWithRound() throws NegativeMinutesOfWorkException, FutureWorkException, InvalidTaskIdException, NoTaskIdException, EmptyTimeFieldException, NotSeparatedTaskTimesException, NotMultipleQuarterHourException, NotExpectedTimeOrderException {
        WorkDay workDay = getNormalWorkDayWithDate();
    ...
    @Test
    public void testEndTimeOfTheLastTask() throws NegativeMinutesOfWorkException, FutureWorkException, InvalidTaskIdException, NoTaskIdException, EmptyTimeFieldException, NotSeparatedTaskTimesException, NotMultipleQuarterHourException, NotExpectedTimeOrderException {
        WorkDay workDay = getNormalWorkDayWithDate();
        Task task1 = getNormalTask1();
        Task task2 = getNormalTask2();
        workDay.addTask(task1);
        ...
        LocalTime result = workDay.endTimeOfTheLastTask();
        assertEquals(expResult, result);
    }
    
    @Test
    public void testEndTimeOfTheLastTaskNoTasks() throws NegativeMinutesOfWorkException, FutureWorkException {
