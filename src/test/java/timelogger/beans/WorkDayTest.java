...
public class WorkDayTest {
    ...
    {
        WorkDay workDay = new WorkDay(2016, 9, 10);
        Task task1 = new Task("4644", "", 7,30,8,45);
        Task task2 = new Task("4654", "", 8,45,9,30);
        Task task3 = new Task("4684", "", 9,30,11,45);
        workDay.addTask(task1);
        workDay.addTask(task2);
        workDay.addTask(task3);
    ...
    @Test
    public void testEndTimeOfTheLastTaskNoTasks()
    {
        WorkDay workDay = new WorkDay(2016, 9, 10);
